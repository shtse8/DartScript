...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _322: x0 => globalThis.document.createElement(x0),
      _323: x0 => globalThis.document.createTextNode(x0),
      _324: x0 => globalThis.document.getElementById(x0),
      _325: (x0,x1) => x0.textContent = x1,
      _326: (x0,x1) => x0.appendChild(x1),
      _328: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _329: (x0,x1) => x0.removeChild(x1),
      _330: (x0,x1,x2) => x0.replaceChild(x1,x2),
      _332: (x0,x1) => x0.removeAttribute(x1),
      _333: (x0,x1,x2) => x0.insertBefore(x1,x2),
      _334: x0 => x0.tagName,
      _335: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _336: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _337: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._337(f,arguments.length,x0) }),
      _338: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._338(f,arguments.length,x0) }),
