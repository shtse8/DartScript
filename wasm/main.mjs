...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _309: (x0,x1) => x0.textContent = x1,
      _310: (x0,x1) => x0.appendChild(x1),
      _311: (x0,x1) => x0.removeChild(x1),
      _312: (x0,x1,x2) => x0.replaceChild(x1,x2),
      _313: (x0,x1,x2) => x0.insertBefore(x1,x2),
      _318: x0 => x0.tagName,
      _319: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _321: (x0,x1) => x0.removeAttribute(x1),
      _329: (x0,x1) => x0.createElement(x1),
      _330: (x0,x1) => x0.createTextNode(x1),
      _331: (x0,x1) => x0.getElementById(x1),
      _332: () => globalThis.document,
      _333: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._333(f,arguments.length,x0) }),
      _334: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _335: (x0,x1,x2) => x0.removeEventListener(x1,x2),
